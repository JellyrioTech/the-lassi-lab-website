...
function Button({ icon, text, url, className }: ButtonProps) {
    return (
        <button
            className={`${className} bg-brand-tertiary rounded p-2 font-bold border border-brand-black drop-shadow-r`}
            type="button"
            onClick={() => window.open(url, "_blank")}
        >
            <p className="inline-flex align-bottom items-center whitespace-nowrap gap-2">
                <span>
                    {icon === "instagram" && (
                        <svg
                            width="20"
